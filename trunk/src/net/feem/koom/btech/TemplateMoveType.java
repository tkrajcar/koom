...
/**
 * Template move type enumeration. Values taken from BTMUX's template.c.
 * 
 * @author cu5
 */
public enum TemplateMoveType {
    BIPED, TRACK, WHEEL, HOVER, VTOL, HULL, FOIL, FLY, QUAD, SUB, NONE;

    public static TemplateMoveType parse(String str) {
        try {
            return TemplateMoveType.valueOf(str);
